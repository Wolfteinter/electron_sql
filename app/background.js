...
function initDb(appPath, callback) {
...
/* harmony import */ var _app_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../app/model */ "./app/model.js");
...
(async () => {
  ...
  (0,_app_model__WEBPACK_IMPORTED_MODULE_3__.initDb)(electron__WEBPACK_IMPORTED_MODULE_0__.app.getPath('userData'), mainWindow.loadURL(`http://localhost:${port}/home`));
})();
